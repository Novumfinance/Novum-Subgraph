...
export class EigenLayerWithdrawalCompleted extends ethereum.Event {
  get params(): EigenLayerWithdrawalCompleted__Params {
    return new EigenLayerWithdrawalCompleted__Params(this);
  }
}

export class EigenLayerWithdrawalCompleted__Params {
  _event: EigenLayerWithdrawalCompleted;

  constructor(event: EigenLayerWithdrawalCompleted) {
    this._event = event;
  }
...
export class ElSharesDelegated extends ethereum.Event {
  get params(): ElSharesDelegated__Params {
    return new ElSharesDelegated__Params(this);
  }
}

export class ElSharesDelegated__Params {
  _event: ElSharesDelegated;

  constructor(event: ElSharesDelegated) {
    this._event = event;
  }

  get elOperator(): Address {
    return this._event.parameters[0].value.toAddress();
  }
}
...
export class NodeDelegator__initiateUnstakingInputQueuedWithdrawalParamStruct extends ethereum.Tuple {
...
export class NodeDelegator extends ethereum.SmartContract {
  ...
  initiateUnstaking(
    queuedWithdrawalParam: NodeDelegator__initiateUnstakingInputQueuedWithdrawalParamStruct,
  ): Bytes {
    let result = super.call(
      "initiateUnstaking",
      "initiateUnstaking((address[],uint256[],address)):(bytes32)",
      [ethereum.Value.fromTuple(queuedWithdrawalParam)],
    );

    return result[0].toBytes();
  }

  try_initiateUnstaking(
    queuedWithdrawalParam: NodeDelegator__initiateUnstakingInputQueuedWithdrawalParamStruct,
...
export class CompleteUnstakingCall extends ethereum.Call {
  get inputs(): CompleteUnstakingCall__Inputs {
    return new CompleteUnstakingCall__Inputs(this);
  }

  get outputs(): CompleteUnstakingCall__Outputs {
    return new CompleteUnstakingCall__Outputs(this);
  }
}

export class CompleteUnstakingCall__Inputs {
  _call: CompleteUnstakingCall;

  constructor(call: CompleteUnstakingCall) {
    this._call = call;
  }

  get withdrawal(): CompleteUnstakingCallWithdrawalStruct {
    return changetype<CompleteUnstakingCallWithdrawalStruct>(
...
export class CompleteUnstakingCall__Outputs {
  _call: CompleteUnstakingCall;
...
export class CompleteUnstakingCallWithdrawalStruct extends ethereum.Tuple {
  get staker(): Address {
...
export class InitiateUnstakingCall extends ethereum.Call {
  get inputs(): InitiateUnstakingCall__Inputs {
    return new InitiateUnstakingCall__Inputs(this);
  }

  get outputs(): InitiateUnstakingCall__Outputs {
    return new InitiateUnstakingCall__Outputs(this);
  }
}

export class InitiateUnstakingCall__Inputs {
  _call: InitiateUnstakingCall;

  constructor(call: InitiateUnstakingCall) {
    this._call = call;
  }

  get queuedWithdrawalParam(): InitiateUnstakingCallQueuedWithdrawalParamStruct {
    return changetype<InitiateUnstakingCallQueuedWithdrawalParamStruct>(
      this._call.inputValues[0].value.toTuple(),
    );
  }
}

export class InitiateUnstakingCall__Outputs {
  _call: InitiateUnstakingCall;
...
export class InitiateUnstakingCallQueuedWithdrawalParamStruct extends ethereum.Tuple {
  get strategies(): Array<Address> {
    return this[0].toAddressArray();
  }
