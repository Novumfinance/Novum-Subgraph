...
export class DepositPool__getAssetDistributionDataResult {
  ...
  getAssetUnstakingFromEigenLayer(): BigInt {
    return this.value3;
  }

  getAssetLyingInConverter(): BigInt {
    return this.value4;
  }

  getAssetLyingUnstakingVault(): BigInt {
    return this.value5;
  }
}
...
export class DepositPool__getETHDistributionDataResult {
  ...
  getEthUnstakingFromEigenLayer(): BigInt {
    return this.value3;
  }

  getEthLyingInConverter(): BigInt {
    return this.value4;
  }

  getEthLyingInUnstakingVault(): BigInt {
    return this.value5;
  }
}
...
export class DepositPool extends ethereum.SmartContract {
  ...
  getAssetDistributionData(
    ...
    let result = super.call(
      "getAssetDistributionData",
      "getAssetDistributionData(address):(uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(asset)],
    );
  ...
  getETHDistributionData(): DepositPool__getETHDistributionDataResult {
    let result = super.call(
      ...
      "getETHDistributionData():(uint256,uint256,uint256,uint256,uint256,uint256)",
      [],
    );
...
export class MaxApproveToLRTConverterCall extends ethereum.Call {
  get inputs(): MaxApproveToLRTConverterCall__Inputs {
    return new MaxApproveToLRTConverterCall__Inputs(this);
  }

  get outputs(): MaxApproveToLRTConverterCall__Outputs {
    return new MaxApproveToLRTConverterCall__Outputs(this);
  }
}

export class MaxApproveToLRTConverterCall__Inputs {
  _call: MaxApproveToLRTConverterCall;

  constructor(call: MaxApproveToLRTConverterCall) {
    this._call = call;
  }
...
export class MaxApproveToLRTConverterCall__Outputs {
  _call: MaxApproveToLRTConverterCall;
